...
const AdminAnggotaPage = () => {
  ...
  const filteredMembers = members.filter((m) => {
    ...
    const matchesInterest =
      filterInterest === 'all' || m.interest === filterInterest;
  ...
  const exportToCSV = () => {
    ...
    link.setAttribute(
      'download',
      `Daftar_Pendaftar_Kartar_${new Date().toISOString().slice(0, 10)}.csv`
    );
      ...
      <div className="admin-page-header">
        <div>
          ...
          <p className="admin-page-subtitle">
            Kelola data pemuda kelurahan yang mendaftar menjadi anggota Karang
            Taruna.
          </p>
        </div>
      ...
      <div className="admin-card">
        ...
        >
          <h2 className="admin-card__title">
            Daftar Registrasi ({filteredMembers.length})
          </h2>
        </div>
          ...
          <div className="admin-table-wrapper">
            {filteredMembers.length > 0 ? (
              ...
              >
                ...
                <p className="admin-text-muted" style={{ fontSize: '0.9rem' }}>
                  Cobalah mencari dengan kata kunci atau filter lain.
                </p>
              </div>
            )}
          </div>
          ...
          <div className="admin-modal">
            ...
            <div className="admin-modal__body" style={{ padding: '1.5rem' }}>
              ...
              >
                ...
                <div>
                  {new Date(selectedMember.createdAt).toLocaleString('id-ID')}
                </div>
              </div>
              ...
              >
                ...
                >
                  <button
                    ...
                    onClick={() =>
                      handleUpdateStatus(selectedMember._id, 'Approved')
                    }
                    disabled={
                      statusUpdating || selectedMember.status === 'Approved'
                    }
                  >
                  ...
                  <button
                    ...
                    onClick={() =>
                      handleUpdateStatus(selectedMember._id, 'Rejected')
                    }
                    disabled={
                      statusUpdating || selectedMember.status === 'Rejected'
                    }
                  >
                  ...
                  {selectedMember.status !== 'Pending' && (
                    <button
                      className="admin-btn admin-btn--outline"
                      onClick={() =>
                        handleUpdateStatus(selectedMember._id, 'Pending')
                      }
                      disabled={statusUpdating}
                    >
                      <i className="fa-solid fa-clock-rotate-left" /> Kembalikan
                      ke Pending
                    </button>
                  )}
                </div>
              ...
              <div
                ...
                style={{ marginTop: '2rem', paddingBottom: 0, border: 'none' }}
              >
                <button
                  className="admin-btn admin-btn--outline"
                  onClick={() => setSelectedMember(null)}
      ...
      {deleteConfirmId && (
        <div className="admin-modal-overlay">
          <div className="admin-modal admin-modal--sm">
            ...
            <div className="admin-modal__body" style={{ padding: '1.5rem' }}>
              <p>
                Apakah Anda yakin ingin menghapus pendaftar ini dari database?
              </p>
              <div
                className="admin-modal__footer"
