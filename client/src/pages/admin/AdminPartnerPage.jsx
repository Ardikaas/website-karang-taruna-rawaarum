...
const AdminPartnerPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const finalCategory =
      form.category === 'kustom' ? form.customCategory.trim() : form.category;
    if (!finalCategory) {
  ...
  const categories = [
    'all',
    ...new Set(list.map((item) => item.category || 'Lainnya')),
  ];
      ...
      <div className="admin-page-header">
        <div>
          <h1 className="admin-page-title">
            Manajemen Kemitraan & Sponsorship
          </h1>
          <p className="admin-page-subtitle">
            Kelola daftar instansi, perusahaan mitra, dan lembaga pendukung
            Karang Taruna.
          </p>
        </div>
        <button
        ...
        <div className="admin-modal-overlay">
          <div className="admin-modal">
            ...
            <form onSubmit={handleSubmit} className="admin-modal__body">
              ...
              <div className="admin-form-group">
                <label className="admin-form-label">
                  Deskripsi Sinergi / Kerjasama (Toolbar Format Interaktif)
                </label>
                <RichTextEditor
