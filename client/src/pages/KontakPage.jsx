    ...
    <div className="subpage-layout">
      ...
      <div className="container subpage-container">
        ...
        <div className="subpage-header text-center">
          ...
          >
            Hubungkan gagasan Anda dengan Karang Taruna Kelurahan Rawa Arum.
            Kami siap berkolaborasi untuk menciptakan dampak sosial dan kemajuan
            daerah yang nyata.
          </p>
        </div>
          ...
          <div className="contact-form-layout">
            ...
            <div className="contact-form-card">
              ...
              <p className="form-card-desc">
                Silakan lengkapi formulir di bawah ini, tim sekretariat kami
                akan memberikan tanggapan resmi maksimal dalam waktu 1x24 jam.
              </p>
              ...
              {success ? (
                <div className="contact-success-state">
                  ...
                  <p>
                    Terima kasih telah menghubungi kami. Tim Karang Taruna Rawa
                    Arum akan segera menanggapi pesan Anda melalui email atau
                    WhatsApp.
                  </p>
                  <button
                ...
                <form className="premium-contact-form" onSubmit={handleSubmit}>
                  ...
                  <div className="form-row-2">
                    ...
                    <div className="form-group-premium">
                      ...
                      <select
                        ...
                        onChange={handleChange}
                      >
                        <option value="Kemitraan & Sponsorship">
                          Kemitraan & Sponsorship (B2B)
                        </option>
                        <option value="Aduan & Layanan Masyarakat">
                          Aduan & Layanan Masyarakat
                        </option>
                        <option value="Kerja Sama Kreatif & Publikasi">
                          Kerja Sama Kreatif & Publikasi
                        </option>
                  ...
                  >
                    {submitting ? (
                      <span>
                        <i className="fa-solid fa-spinner fa-spin"></i> Sedang
                        Mengirim...
                      </span>
                    ) : (
                      <span>
